    ...
    let avater = function (resTime) {
        ...
        switch (true) {
            case resTime >= 500:
                data = {
                    name: "Turtle",
                    img: "./static/media/gif/turtle.gif"
                }
                break;
            ...
            case resTime >= 400:
                data = {
                    name: "Uncle Grandpa",
                    img: "./static/media/gif/uncle-grandpa.gif"
                }
                break;
            ...
            case resTime >= 300:
                data = {
                    name: "Human",
                    img: "./static/media/gif/human.gif"
                }
                break;
            ...
            case resTime >= 250:
                data = {
                    name: "BatMan",
                    img: "./static/media/gif/batman.gif"
                }
                break;
            ...
            case resTime >= 200:
                data = {
                    name: "Spider-Man",
                    img: "./static/media/gif/spiderman.gif"
                }
                break;
            ...
            case resTime >= 180:
                data = {
                    name: "Quick-Silver",
                    img: "./static/media/gif/quicksilver.gif"
                }
                break;
            ...
            case resTime >= 150:
                data = {
                    name: "Superman",
                    img: "./static/media/gif/superman.gif"
                }
                break;
            ...
            case resTime >= 130:
                data = {
                    name: "Flash",
                    img: "./static/media/gif/flash.gif"
                }
                break;
            ...
            case resTime >= 100:
                data = {
                    name: "Thunder-Bold",
                    img: "./static/media/gif/thunder.gif"
                }
                break;
            ...
            case resTime > 0: {
                data = {
                    name: "Super Human",
                    img: "./static/media/gif/superhuman.gif",
                }
                break;
            }
